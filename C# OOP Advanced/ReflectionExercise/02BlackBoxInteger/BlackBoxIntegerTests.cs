...
class BlackBoxIntegerTests
{
    public static void Main()
    {
        ...
        while (command != "END")
        {
            ...
            MethodInfo targetMethod = blackBoxIntClassType
                .GetMethod(commandType, BindingFlags.NonPublic | BindingFlags.Instance);

            targetMethod
                .Invoke(blackBoxIntClassInstance, new object[] { commandValue });

            FieldInfo valueField = blackBoxIntClassType
